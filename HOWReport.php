...
<head>
    <meta charset="UTF-8">
    <title>Home Warranty Inspection Report</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="easyui-tabs" style="width:100%;" data-options="tabWidth:250">
        <div title="Booking Information" style="padding:10px;font-size: 18px" >
            <div class="easyui-tabs" data-options="fit:true,plain:true" style="width:inherit;height:500px">
                    ...
                    <form>
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <input id="owner_address" class="form-control" type="text" title="address"  style="margin-top: 0" value="<?php echo doNiceArrayElemAsString('address1'); ?>">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm">
                                <label>Suburb</label><br>
                                <input  id="owner_suburb" class="form-control" type="text" title="suburb" style="margin-top: 0" value="<?php echo doNiceArrayElemAsString('city'); ?>">
                            </div>
                            <div class="col-sm">
                                <label>State</label><br>
                                <input id="owner_state" class="form-control" type="text" title="state"  style="margin-top: 0" value="<?php echo doNiceArrayElemAsString('state', false); ?>">
                            </div>
                            <div class="col-sm">
                                <label>Postcode</label><br>
                                <input id="owner_postcode" class="form-control" type="text" title="postcode" style="margin-top: 0" value="<?php echo doNiceArrayElemAsString('postcode'); ?>">
                            </div>
                        </div>
                    </form>
                    <form>
                ...
                <div title="INSPECTION   DETAILS" style="padding:10px; font-size: 18px">
                    <form>
                        <div class="row">
                            <div class="col-sm-8">
                                <label>Address</label><br>
                                <input id="inspection_address" class="form-control" type="text" title="address" style="margin-top: 0">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <label>Suburb</label><br>
                                <input id="inspection_suburb" class="form-control" type="text" title="suburb" style="margin-top: 0">
                            </div>
                            <div class="col-sm-4">
                                <label>State</label><br>
                                <input id="inspection_state" class="form-control" type="text" title="state" style="margin-top: 0">
                            </div>
                            <div class="col-sm-4">
                                <label>Postcode</label><br>
                                <input id="inspection_postcode" class="form-control" type="text" title="postcode" style="margin-top: 0">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                ...
                <div title="REPORT AUTHORISATION (For Victoria only)" style="padding:10px;font-size: 18px">
                    <form>
                        <div class="row form-group">
                            <div class="col-sm">
                ...
                <div title="EXTENT OF WORK DONE BY OWNER BUILDER " style="padding:10px;font-size: 18px">
                    <form>
                        <div class="row form-group">
                            <div class="col-sm-3">
        ...
        <div title="INTERNAL LIVING & BEDROOM" style="padding: 10px;">
            <div class="easyui-tabs" style="padding:10px">
                <div title="Entry&Passage" style="padding:10px;font-size: 18px">
...
<div class="container" style="text-align:center">
    ...
    <button onclick="generateHOWPDF('final')" type="button" class="btn btn-primary">View as PDF</button>
    <button onclick="generateHOWPDF('save')" type="button" class="btn btn-primary">Save as Report for Customer</button>
    <?php
        }
        else
        {
    ...
    ?>
    <button onclick="generateHOWPDF('preview')" type="button" class="btn btn-primary">Preview PDF</button>
    <?php
        }
      }
    ?>
