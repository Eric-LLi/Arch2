                ...
                <div title="Booking Information" id="booingInformation" style="padding:10px;font-size: 18px">
                    <div class="easyui-tabs" data-options="fit:true,plain:true" style="width:inherit;height:500px">
                        ...
                        <div title="DETAILS OF ADVICE SOUGHT" style="padding:10px;font-size: 18px">
                            <textarea id="Text_Details_Advice" class="form-control" style="height: 100%;" autofocus></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="easyui-tabs" data-options="plain:true" style="width:inherit;height:auto">
                        <div title="Check Home Accessment" style="padding:10px;font-size: 18px">
                            <table>
                                ...
                                <tr>
                                    <td><label>Has the H&ampS CHECKLIST been completed?</label></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <textarea style="padding:0px;"> </textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <select style="width:100%">
                                            ...
                                            <option value="Bathroom Modification">Bathroom Modification</option>
                                            <option value="Platform Steps ">Platform Steps </option>
                                            <option value="Other" onselect="">Other</option>
                                        </select>
                                    </td>
                                    <td>
                                        <textarea id="Text_Design"></textarea>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div title="Repairs & Mainentance" style="padding:10px;font-size: 18px">
                        </div>
                    </div>
                </div>
                <!--
...
-->
                ...
                <div title="Property Exterior" style="padding: 10px;font-size: 18px">
                    <div class="easyui-tabs">
                        ...
                        <div title="Access Limitations (U)" style="padding: 10px;font-size: 18px;">
                            <button type="button" class="btn btn-primary" onclick="addOneAccessLimitation('exteriorAccessLimitationsTable','exteriorAccessItem','exteriorAccessImageRef','exteriorAccessSelect','exteriorAccessNotes')"
                                    style="margin-bottom: 10px;font-size: 18px">Add One Access Limitation</button>
                ...
                <div title="Property Interior – Dry Areas" data-options="tools:'#p-tools'" style="padding: 10px;font-size: 18px">
                    <div class="easyui-tabs">
                        ...
                        <div title="Access Limitations (U)" style="padding: 10px;font-size: 18px;">
                            <button type="button" class="btn btn-primary" onclick="addOneAccessLimitation('interiorDryAccessLimitationsTable','interiorDryAccessItem','interiorDryAccessImageRef','interiorDryAccessSelect','interiorDryAccessNotes')"
                                    style="margin-bottom: 10px;font-size: 18px">Add One Access Limitation</button>
                ...
                <div title="Property Interior – Service (wet) Areas" data-options="tools:'#p-tools'" style="padding: 10px;font-size: 18px">
                    <div class="easyui-tabs">
                        ...
                        <div title="Access Limitations (U)" style="padding: 10px;font-size: 18px;">
                            <button type="button" class="btn btn-primary" onclick="addOneAccessLimitation('interiorWetAccessLimitationsTable','interiorWetAccessItem','interiorWetAccessImageRef','interiorWetAccessSelect','interiorWetAccessNotes')"
                                    style="margin-bottom: 10px;font-size: 18px">Add One Access Limitation</button>
        ...
        <!--General Functions-->
        <script src="HomeAccessJS/htmlGeneralFunctions.js"></script>
