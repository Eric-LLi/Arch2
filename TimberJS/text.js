...
var previousPestTreatmentText = 'Please Note: Evidence of previous termite treatment or other termit management system does not guarantee its current effectiveness. Ground and or environmental conditions may have been disturbed during maintenance or in preparing the property for sale. Where a reticulated system has been installed, a pressure check and top-up may required. We recommend contacting the provider for advice or re-inspection. If no written evidenc of a termite management system to AS 3600-2000 is provided, a treatment should always be considered to prevent attack.';

var recommendationsText = 'Please Note: The recommendation for future inspections should be viewed as part of a household maintenance program and is independent of any inspections that may form part of a recommended treatment. If a treatment is recommended the treatment should be undertaken without delay. Regular inpsections will not prevent future attack by subterranean termites or other timber pests but they will assist with the identifiaction of activity. Detection at the earliest opportunity will allow treatment to be commenced and damage minimised.';
