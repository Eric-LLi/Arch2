...
<div class="container">
    ...
    <h2 class="content-head text-center firstH1">PROPERTY ASSESSMENT REPORT</h2><br>
    <p>
        This Property Assessment Report is a visual assessment of the conditions of the reasonably accessible areas of
        the property at the time of the assessment,
        including the subject residence and associated areas where the property is a unit or apartment.
    </p>
</div>
<!--Details-->
<div class="container">
...
<!--Summary-->
<div class="container">
    <h2 class="content-head text-center firstH1">YOUR PROPERTY ASSESSMENT SUMMARY</h2><br>
    <p>
        This Property Assessment summary provides you with a “snapshot” of the items the architect considers of
        greatest significance for you when considering this property. Please refer to the Definitions and the
        complete Report for detailed information regarding visible defects and recommended actions.
        Please note that this summary is not the complete Report and that in the event of an apparent
        discrepancy the complete Report overrides the Summary information.
    </p>
    <hr>
</div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="row">
                <form>
                    <div class="col-sm">
                        <img id="AssessmentCoverImage" src="#" alt="Image1"
                             style="width:265px;height:265px;display: none"/>
                    </div>
                    <div class="col-sm">
                        <input type="button" value="Remove" id="AssessmentCoverImageRemoveButton"
                               onclick="RemoveAssessmentCoverImage()" style="display: none; margin-top: 5px;margin-bottom: 5px;width: 100%">
                        <br>
                    </div>
                </form>
            </div>
...
<div id="evidentDefectSummary" class="container">
    ...
    <div class="row" id="EDRow0">
        <div class="col-sm-4" id="ED0">
            <label id="EDName0">Damp</label><br>
        ...
        <div class="col-sm-4" id="ED1" title="EDSelect">
            <label id="EDName1">Framing</label><br>
        ...
        <div class="col-sm-4" id="ED2" title="EDSelect">
            <label id="EDName2">Stumps / Piers</label><br>
    ...
    <div class="row" id="EDRow1">
        <div class="col-sm" id="ED3">
            <label id="EDName3">Cracking</label><br>
        ...
        <div class="col-sm" id="ED4">
            <label id="EDName4">Water Supply</label><br>
        ...
        <div class="col-sm" id="ED5">
            <label id="EDName5">Timber Rot</label><br>
    ...
    <div class="row" id="EDRow2">
        <div class="col-sm" id="ED6">
            <label id="EDName6">Electrics</label><br>
        ...
        <div class="col-sm" id="ED7">
            <label id="EDName7">Roof</label><br>
        ...
        <div class="col-sm" id="ED8">
            <label id="EDName8">Suspected Illegal Building</label><br>
...
<!--Site and Garden-->
<div class="container">
    <h2 class="content-head text-center firstH1">Site & Garden</h2><br>
</div>
        ...
        <tr>
            <th style="width: 20%;font-weight: normal">
                ...
                <input type="button" value="Upload Image" class="uploadImageButton"
                       onclick="AssessmentSiteUploadImages()">
                <input type="file" id="AssessmentSiteUploadImages" class="inputImage" accept="image/x-png,image/jpeg"
                       multiple>
            </th>
            <th>
                <div class="row form-group">
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentSiteImage0" src="#" alt="Image1"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentSiteImageText0"
                                   style="width:265px;height:10px; display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentSiteRemoveButton0"
                                   onclick="RemoveAssessmentSiteImage0()" style="display: none ; width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentSiteImageButton0"
                                   onclick="AddAssessmentSiteImage0()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentSiteUploadImage0" class="inputImage"
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentSiteImage1" src="#" alt="Image2"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentSiteImageText1"
                                   style="width:265px;height:10px ;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentSiteRemoveButton1"
                                   onclick="RemoveAssessmentSiteImage1()" style="width:265px;display: none ">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentSiteImageButton1"
                                   onclick="AddAssessmentSiteImage1()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentSiteUploadImage1" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                        </div>
                    </form>
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentSiteImage2" src="#" alt="Image3"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentSiteImageText2"
                                   style="width:265px;height:10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentSiteRemoveButton2"
                                   onclick="RemoveAssessmentSiteImage2()" style="display:none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentSiteImageButton2"
                                   onclick="AddAssessmentSiteImage2()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentSiteUploadImage2" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                        </div>
                    </form>
                </div>
...
<div class="container">
    ...
    <table id="AssessmentSiteNotesTable">
        ...
        <tr>
            ...
            <td height="30%"><textarea class="form-control" style="height:91px" title="AssessmentSiteLimitationNote" id="AssessmentSiteLimitationNote0"></textarea></td>
        </tr>
        <tr>
            <td colspan="2" class="sectionSubHead">Major and Serious Structural Defects Found:</td>
        </tr>
        <tr>
            <td colspan="2"> <textarea id="AssessmentSiteMajorFound" class="form-control" title="MajorNotes"></textarea></td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="2"> <textarea id="AssessmentSiteMinorFound" class="form-control" title="MajorNotes"></textarea></td>
        </tr>
        <tr>
            <td>
                <label class="sectionSubHead" style="color:black">Professional & Trade Recommendations:</label>
        ...
        <tr>
            <td colspan="2"><label class="sectionSubHead">General Notes:</label><br></td>
        </tr>
        <tr>
            <td colspan="2">
...
<!--Property Exterior-->
<div class="container">
    <h2 class="content-head text-center firstH1">Property Exterior</h2><br>
</div>
...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm">
                <label>Overhanging Trees</label><br>
        ...
        <div class="row">
            <div class="col-sm">
                <label>Chimney/Vents/Flues</label><br>
    ...
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm">
                <label>Underside of Roof</label><br>
    ...
    <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <label>Ventilation/Damp</label><br>
        ...
        <div class="row">
            <div class="col-sm">
                <label>Underside of Floor</label><br>
    ...
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm">
                <label>Structure/Finish</label><br>
            ...
            <div class="col-sm">
                <label>Gutter Downpipe</label><br>
        ...
        <div class="row">
            <div class="col-sm">
                <label>Sub-Floor Vents</label><br>
    ...
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm">
                <label>Floor Structure</label><br>
            ...
            <div class="col-sm">
                <label>Posts/Balustrade</label><br>
    ...
    <table id="AccessmentExteriorImages">
        <tr>
            <th style="width: 20%;font-weight: normal">
                ...
                <br>
                <input type="button" value="Upload Image" class="uploadImageButton"
                       onclick="AssessmentExteriorUploadImages()">
                <input type="file" id="AssessmentExteriorUploadImages" class="inputImage"
            ...
            <th>
                <div class="row form-group">
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentExteriorImage0" src="#" alt="Image1"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentExteriorImageText0"
                                   style="width:265px;height:10px; display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentExteriorRemoveButton0"
                                   onclick="RemoveAssessmentExteriorImage0()" style="display: none ; width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentExteriorImageButton0"
                                   onclick="AddAssessmentExteriorImage0()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentExteriorUploadImage0" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                            <br>
                        </div>
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentExteriorImage1" src="#" alt="Image2"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentExteriorImageText1"
                                   style="width:265px;height:10px ;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentExteriorRemoveButton1"
                                   onclick="RemoveAssessmentExteriorImage1()" style="width:265px;display: none ">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentExteriorImageButton1"
                                   onclick="AddAssessmentExteriorImage1()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentExteriorUploadImage1" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                        </div>
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentExteriorImage2" src="#" alt="Image3"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentExteriorImageText2"
                                   style="width:265px;height:10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentExteriorRemoveButton2"
                                   onclick="RemoveAssessmentExteriorImage2()" style="display:none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentExteriorImageButton2"
                                   onclick="AddAssessmentExteriorImage2()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentExteriorUploadImage2" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                        </div>
                    </form>
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentExteriorImage3" src="#" alt="Image4"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image4" placeholder="name" id="AssessmentExteriorImageText3"
                                   style="width:265px;height:10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentExteriorRemoveButton3"
                                   onclick="RemoveAssessmentExteriorImage3()" style="display: none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentExteriorImageButton3"
                                   onclick="AddAssessmentExteriorImage3()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentExteriorUploadImage3" class="inputImage"
                                   style="display: none">
                        </div>
                    </form>
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentExteriorImage4" src="#" alt="Image5"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image5" placeholder="name" id="AssessmentExteriorImageText4"
                                   style="width:265px;height:10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentExteriorRemoveButton4"
                                   onclick="RemoveAssessmentExteriorImage4()" style="display:none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentExteriorImageButton4"
                                   onclick="AddAssessmentExteriorImage4()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentExteriorUploadImage4" class="inputImage"
                                   style="display: none">
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentExteriorImage5" src="#" alt="Image6"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image5" placeholder="name" id="AssessmentExteriorImageText5"
                                   style="width:265px;height: 10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentExteriorRemoveButton5"
                                   onclick="RemoveAssessmentExteriorImage5()" style="display:none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentExteriorImageButton5"
                                   onclick="AddAssessmentExteriorImage5()" style="width:265px;display:none ">
                            <input type="file" id="AssessmentExteriorUploadImage5" class="inputImage"
                                   style="display: none">
                        </div>
                    </form>
                </div>
...
<div class="container">
    ...
    <table id="AssessmentPropertyExteriorNotesTable">
        ...
        <tr>
            ...
            <td height="30%"><textarea class="form-control" style="height:91px" title="AssessmentSiteLimitationNote" id="AssessmentPropertyExteriorLimitationNote0"></textarea></td>
        </tr>
        <tr>
            <td colspan="2" class="sectionSubHead">Major and Serious Structural Defects Found:</td>
        </tr>
        <tr>
            <td colspan="2"> <textarea id="AssessmentPropertyExteriorMajorFound" class="form-control" title="MajorNotes"></textarea></td>
        </tr>
        <tr>
            <td>
                <label class="sectionSubHead" style="color: black">Professional & Trade Recommendations:</label>
        ...
        <tr>
            <td colspan="2"> <textarea id="AssessmentPropertyExteriorMinorFound" class="form-control" title="MajorNotes"></textarea></td>
        </tr>
        <tr>
            <td>
                <label class="sectionSubHead" style="color:black">Professional & Trade Recommendations:</label>
...
<div class="container">
    <h2 class="content-head text-center firstH1">Property Interior - Living Areas</h2><br>
</div>
...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="row form-group">
            <div class="col-sm">
                <label>Floor Structure/Finish</label><br>
    ...
    <div class="form-group" id="LivingAreaKitchen1">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm">
                <label>Sink/Water Pressure</label><br>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm">
                <label>Exhaust/Rangehood</label><br>
            ...
            <div class="col-sm">
                <label>Stove/Cooktop/Oven</label><br>
        ...
        <tr>
            <th style="width: 20%;font-weight: normal">
                ...
                <input type="button" id="get_image" value="Upload Image" class="uploadImageButton"
                       onclick="AssessmentInteriorLivingUploadImages()">
                <input type="file" id="AssessmentInteriorLivingUploadImages" class="inputImage"
                       accept="image/x-png,image/jpeg" multiple>
            </th>
            <th>
                <div class="row form-group">
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorLivingImage0" src="#" alt="Image1"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentInteriorLivingImageText0"
                                   style="width:265px;height:10px; display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton0"
                                   onclick="RemoveAssessmentInteriorLivingImage0()" style="display:none ; width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton0"
                                   onclick="AddAssessmentInteriorLivingImage0()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorLivingUploadImage0" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                            <br>
                        </div>
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorLivingImage1" src="#" alt="Image2"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentInteriorLivingImageText1"
                                   style="width:265px;height:10px ;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton1"
                                   onclick="RemoveAssessmentInteriorLivingImage1()" style="width:265px;display: none ">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton1"
                                   onclick="AddAssessmentInteriorLivingImage1()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorLivingUploadImage1" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                        </div>
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorLivingImage2" src="#" alt="Image3"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentInteriorLivingImageText2"
                                   style="width:265px;height:10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton2"
                                   onclick="RemoveAssessmentInteriorLivingImage2()" style="display:none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton2"
                                   onclick="AddAssessmentInteriorLivingImage2()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorLivingUploadImage2" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                        </div>
                    </form>
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorLivingImage3" src="#" alt="Image4"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image4" placeholder="name" id="AssessmentInteriorLivingImageText3"
                                   style="width:265px;height: 10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton3"
                                   onclick="RemoveAssessmentInteriorLivingImage3()" style="display: none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton3"
                                   onclick="AddAssessmentInteriorLivingImage3()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorLivingUploadImage3" class="inputImage"
                                   style="display: none">
                        </div>
                    </form>
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorLivingImage4" src="#" alt="Image5"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image5" placeholder="name" id="AssessmentInteriorLivingImageText4"
                                   style="width:265px;height: 10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton4"
                                   onclick="RemoveAssessmentInteriorLivingImage4()" style="display: none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton4"
                                   onclick="AddAssessmentInteriorLivingImage4()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorLivingUploadImage4" class="inputImage"
                                   style="display: none">
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorLivingImage5" src="#" alt="Image6"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image5" placeholder="name" id="AssessmentInteriorLivingImageText5"
                                   style="width:265px;height: 10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton5"
                                   onclick="RemoveAssessmentInteriorLivingImage5()" style="display: none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton5"
                                   onclick="AddAssessmentInteriorLivingImage5()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorLivingUploadImage5" class="inputImage"
                                   style="display: none">
                        </div>
                    </form>
                </div>
...
<div class="container">
    <h2 class="content-head text-center firstH1">Property Interior - Bedroom Areas</h2><br>
</div>
    ...
    <table id="AccessmentInteriorBedroomImages">
        <tr>
            <th style="width: 20%;font-weight: normal">
                ...
                <br>
                <input type="button" value="Upload Image" class="uploadImageButton"
                       onclick="AssessmentInteriorBedroomUploadImages()">
                <input type="file" id="AssessmentInteriorBedroomUploadImages" class="inputImage"
                       accept="image/x-png,image/jpeg" multiple>
            </th>
            <th>
                <div class="row form-group">
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorBedroomImage0" src="#" alt="Image1"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentInteriorBedroomImageText0"
                                   style="width:265px;height:10px; display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton0"
                                   onclick="RemoveAssessmentInteriorBedroomImage0()"
                                   style="display: none ; width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton0"
                                   onclick="AddAssessmentInteriorBedroomImage0()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorBedroomUploadImage0" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                            <br>
                        </div>
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorBedroomImage1" src="#" alt="Image2"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentInteriorBedroomImageText1"
                                   style="width:265px;height:10px ;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton1"
                                   onclick="RemoveAssessmentInteriorBedroomImage1()" style="width:265px;display: none ">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton1"
                                   onclick="AddAssessmentInteriorBedroomImage1()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorBedroomUploadImage1" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                        </div>
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorBedroomImage2" src="#" alt="Image3"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentInteriorBedroomImageText2"
                                   style="width:265px;height:10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton2"
                                   onclick="RemoveAssessmentInteriorBedroomImage2()" style="display:none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton2"
                                   onclick="AddAssessmentInteriorBedroomImage2()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorBedroomUploadImage2" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                        </div>
                    </form>
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorBedroomImage3" src="#" alt="Image4"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image4" placeholder="name" id="AssessmentInteriorBedroomImageText3"
                                   style="width:265px;height: 10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton3"
                                   onclick="RemoveAssessmentInteriorBedroomImage3()" style="display:none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton3"
                                   onclick="AddAssessmentInteriorBedroomImage3()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorBedroomUploadImage3" class="inputImage"
                                   style="display: none">
                        </div>
                    </form>
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorBedroomImage4" src="#" alt="Image5"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image5" placeholder="name" id="AssessmentInteriorBedroomImageText4"
                                   style="width:265px;height:10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton4"
                                   onclick="RemoveAssessmentInteriorBedroomImage4()" style="display: none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton4"
                                   onclick="AddAssessmentInteriorBedroomImage4()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorBedroomUploadImage4" class="inputImage"
                                   style="display: none">
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorBedroomImage5" src="#" alt="Image6"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image5" placeholder="name" id="AssessmentInteriorBedroomImageText5"
                                   style="width:265px;height:10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton5"
                                   onclick="RemoveAssessmentInteriorBedroomImage5()" style="display: none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton5"
                                   onclick="AddAssessmentInteriorBedroomImage5()" style="width:265px;display:none">
                            <input type="file" id="AssessmentInteriorBedroomUploadImage5" class="inputImage"
                                   style="display: none">
                        </div>
                    </form>
                </div>
...
<div class="container">
    ...
    <table id="AssessmentPropertyInteriorNotesTable">
        ...
        <tr>
            ...
            <td height="30%"><textarea class="form-control" style="height:91px" title="AssessmentSiteLimitationNote" id="AssessmentPropertyInteriorLimitationNote0"></textarea></td>
        </tr>
        <tr>
            <td colspan="2" class="sectionSubHead">Major and Serious Structural Defects Found:</td>
        </tr>
        <tr>
            <td colspan="2"> <textarea id="AssessmentPropertyInteriorMajorFound" class="form-control" title="MajorNotes"></textarea></td>
        </tr>
        <tr>
            <td>
                <label class="sectionSubHead" style="color: black">Professional & Trade Recommendations:</label>
        ...
        <tr>
            <td colspan="2"> <textarea id="AssessmentPropertyInteriorMinorFound" class="form-control" title="MajorNotes"></textarea></td>
        </tr>
        <tr>
            <td>
                <label class="sectionSubHead" style="color:black">Professional & Trade Recommendations:</label>
...
<div class="container">
    <h2 class="content-head text-center firstH1">Property Interior - Service (Wet) Areas</h2><br>
</div>
...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="row form-group">
            <div class="col-sm">
                <label>Cupboards/Vanity</label><br>
        ...
        <div class="row form-group">
            <div class="col-sm">
                <label>Exhaust/Ventilation</label><br>
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <label>Basin/Splashback</label><br>
...
<div class="container">
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm">
                <label>Tub/Sink/Splashback</label><br>
...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm">
                <label>Smoke Detector/s</label><br>
            ...
            <div class="col-sm">
                <label>Hot Water Service</label><br>
    ...
    <table id="AccessmentInteriorServiceImages">
        <tr>
            <th style="width: 20%;font-weight: normal">
                ...
                <br>
                <input type="button" value="Upload Image" class="uploadImageButton"
                       onclick="AssessmentInteriorServiceUploadImages()">
                <input type="file" id="AssessmentInteriorServiceUploadImages" class="inputImage"
                       accept="image/x-png,image/jpeg" multiple>
            </th>
            <th>
                <div class="row form-group">
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorServiceImage0" src="#" alt="Image1"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentInteriorServiceImageText0"
                                   style="width:265px;height:10px; display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorServiceRemoveButton0"
                                   onclick="RemoveAssessmentInteriorServiceImage0()"
                                   style="display: none ; width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorServiceImageButton0"
                                   onclick="AddAssessmentInteriorServiceImage0()" style="width:265px;display:none ">
                            <input type="file" id="AssessmentInteriorServiceUploadImage0" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                            <br>
                        </div>
                    </form>
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorServiceImage1" src="#" alt="Image2"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentInteriorServiceImageText1"
                                   style="width:265px;height:10px ;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorServiceRemoveButton1"
                                   onclick="RemoveAssessmentInteriorServiceImage1()" style="width:265px;display: none ">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorServiceImageButton1"
                                   onclick="AddAssessmentInteriorServiceImage1()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorServiceUploadImage1" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                        </div>
                    ...
                    <form>
                        <div class="col-sm">
                            <img id="AssessmentInteriorServiceImage2" src="#" alt="Image3"
                                 style="width:265px;height:265px;display: none"/>
                        </div>
                        <div class="col-sm">
                            <input type="text" name="image1" placeholder="name" id="AssessmentInteriorServiceImageText2"
                                   style="width:265px;height:10px;display: none">
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Remove" id="AssessmentInteriorServiceRemoveButton2"
                                   onclick="RemoveAssessmentInteriorServiceImage2()" style="display:none;width:265px">
                            <br>
                        </div>
                        <div class="col-sm">
                            <input type="button" value="Add" id="AddAssessmentInteriorServiceImageButton2"
                                   onclick="AddAssessmentInteriorServiceImage2()" style="width:265px;display: none ">
                            <input type="file" id="AssessmentInteriorServiceUploadImage2" class="inputImage"
                                   accept="image/x-png,image/jpeg" style="display: none">
                        </div>
                    </form>
                </div>
...
<div class="container">
    ...
    <table id="AssessmentServiceNotesTable">
        ...
        <tr>
            ...
            <td height="30%"><textarea class="form-control" style="height:91px" title="AssessmentSiteLimitationNote" id="AssessmentServiceLimitationNote0"></textarea></td>
        </tr>
        <tr>
            <td colspan="2" class="sectionSubHead">Major and Serious Structural Defects Found:</td>
        </tr>
        <tr>
            <td colspan="2"> <textarea id="AssessmentServiceMajorFound" class="form-control" title="MajorNotes"></textarea></td>
        </tr>
        <tr>
            <td>
                <label class="sectionSubHead" style="color: black">Professional & Trade Recommendations:</label>
        ...
        <tr>
            <td colspan="2"> <textarea id="AssessmentServiceMinorFound" class="form-control" title="MajorNotes"></textarea></td>
        </tr>
        <tr>
            <td>
                <label class="sectionSubHead" style="color:black">Professional & Trade Recommendations:</label>
    ...
    <p>
       ...
       <!--  <a href="http://www.archicentreaustralia.com.au/report_downloads/">click here</a> -->
        <a href="http://www.archicentreaustralia.com.au/report_downloads/">http://www.archicentreaustralia.com.au/report_downloads/</a>
         - or by referring to the Report cover email for downloading instructions. If you have difficulty downloading
        the
...
<div class="container" style="text-align:center">
    ...
    <button onclick="startGenerating('final')" type="button" class="btn btn-primary">View as PDF</button>
    <button onclick="startGenerating('save')" type="button" class="btn btn-primary">Save as Report for Customer</button>
    <?php
        }
        else
        {
