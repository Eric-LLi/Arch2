...
?>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p>
                This Property Assessment Report is a visual assessment of the conditions of the reasonably accessible areas of the property at the time of the assessment, including the subject residence and associated areas where the property is a unit or apartment.
            </p>
        </div>
        <!--Details-->
        <div class="container">
...
-->
                ...
                <div class="col-sm-6">
                    ...
                    <div class="row">
                        <form>
                            ...
                            <div class="col-sm">
                                <input type="button" value="Remove" id="AssessmentCoverImageRemoveButton" onclick="RemoveAssessmentCoverImage()" style="display: none; margin-top: 5px;margin-bottom: 5px;width: 100%">
                                <br>
                            </div>
                        </form>
                    </div>
                    ...
                    <th>
                        <div class="row form-group">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentSiteRemoveButton0" onclick="RemoveAssessmentSiteImage0()" style="display: none ; width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentSiteRemoveButton2" onclick="RemoveAssessmentSiteImage2()" style="display:none;width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
        ...
        <div class="container">
            ...
            <div id="PropertyExteriorWall" style="display: none">
                <div class="form-group">
                    <div class="row form-group">
                        <div class="col-sm-3"><input id="2007" placeholder="Wall #1" class="form-control" type="text"></div>
                ...
                <div class="form-group">
                    <div class="row form-group">
                        <div class="col-sm-3"><input id="2008" placeholder="Wall #2" class="form-control" type="text"></div>
                ...
                <div class="form-group">
                    <div class="row form-group">
                        <div class="col-sm-3"><input id="2009" placeholder="Wall #3" class="form-control" type="text"></div>
                        <!--id:ExteriorWall3-->
                    </div>
                    <div class="row">
                        <div class="col-sm">
                ...
                <div class="form-group">
                    <div class="row form-group">
                        <div class="col-sm-3"><input id="2010" placeholder="Wall #4" class="form-control" type="text"></div>
                    ...
                    <th>
                        <div class="row form-group">
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton0" onclick="RemoveAssessmentInteriorLivingImage0()" style="display:none ; width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton0" onclick="AddAssessmentInteriorLivingImage0()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton1" onclick="RemoveAssessmentInteriorLivingImage1()" style="width:265px;display: none ">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton1" onclick="AddAssessmentInteriorLivingImage1()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton2" onclick="RemoveAssessmentInteriorLivingImage2()" style="display:none;width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton2" onclick="AddAssessmentInteriorLivingImage2()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton3" onclick="RemoveAssessmentInteriorLivingImage3()" style="display: none;width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton3" onclick="AddAssessmentInteriorLivingImage3()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton4" onclick="RemoveAssessmentInteriorLivingImage4()" style="display: none;width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton4" onclick="AddAssessmentInteriorLivingImage4()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorLivingRemoveButton5" onclick="RemoveAssessmentInteriorLivingImage5()" style="display: none;width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorLivingImageButton5" onclick="AddAssessmentInteriorLivingImage5()" style="width:265px;display: none ">
                    ...
                    <th>
                        <div class="row form-group">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton0" onclick="RemoveAssessmentInteriorBedroomImage0()" style="display: none ; width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton0" onclick="AddAssessmentInteriorBedroomImage0()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton1" onclick="RemoveAssessmentInteriorBedroomImage1()" style="width:265px;display: none ">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton1" onclick="AddAssessmentInteriorBedroomImage1()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton2" onclick="RemoveAssessmentInteriorBedroomImage2()" style="display:none;width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton2" onclick="AddAssessmentInteriorBedroomImage2()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton3" onclick="RemoveAssessmentInteriorBedroomImage3()" style="display:none;width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton3" onclick="AddAssessmentInteriorBedroomImage3()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton4" onclick="RemoveAssessmentInteriorBedroomImage4()" style="display: none;width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton4" onclick="AddAssessmentInteriorBedroomImage4()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorBedroomRemoveButton5" onclick="RemoveAssessmentInteriorBedroomImage5()" style="display: none;width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorBedroomImageButton5" onclick="AddAssessmentInteriorBedroomImage5()" style="width:265px;display:none">
                    ...
                    <th>
                        <div class="row form-group">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorServiceRemoveButton0" onclick="RemoveAssessmentInteriorServiceImage0()" style="display: none ; width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorServiceImageButton0" onclick="AddAssessmentInteriorServiceImage0()" style="width:265px;display:none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorServiceRemoveButton1" onclick="RemoveAssessmentInteriorServiceImage1()" style="width:265px;display: none ">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorServiceImageButton1" onclick="AddAssessmentInteriorServiceImage1()" style="width:265px;display: none ">
                            ...
                            <form>
                                ...
                                <div class="col-sm">
                                    <input type="button" value="Remove" id="AssessmentInteriorServiceRemoveButton2" onclick="RemoveAssessmentInteriorServiceImage2()" style="display:none;width:265px">
                                    <br>
                                </div>
                                <div class="col-sm">
                                    <input type="button" value="Add" id="AddAssessmentInteriorServiceImageButton2" onclick="AddAssessmentInteriorServiceImage2()" style="width:265px;display: none ">
        ...
        <div class="container">
            <hr>
            <p>
                The following selected attachments are an important part of this Report. These can be downloaded from the Archicentre Australia Supplementary Documents page -
                <!--suppress HtmlUnknownTarget -->
                <!--  <a href="http://www.archicentreaustralia.com.au/report_downloads/">click here</a> -->
                <a href="http://www.archicentreaustralia.com.au/report_downloads/">http://www.archicentreaustralia.com.au/report_downloads/</a> - or by referring to the Report cover email for downloading instructions. If you have difficulty downloading the following ticked attachments, please contact Archicentre Australia on 1300 13 45 13 immediately.
            </p>
        </div>
