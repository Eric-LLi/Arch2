...
<head>
    <meta charset="UTF-8">
    <title>Post Dilapidation Survey Report</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <form>
        <div class="row">
            ...
            <div class="col-sm">
                ...
                <input id="PDCustomerPhone" class="form-control" type="text" title="phone" value="<?php echo doNiceArrayElemAsString('custmobile'); ?>">
            </div>
            <div class="col-sm">
    ...
    <form>
        <div class="row">
            <div class="col-sm">
                ...
                <input id="PDAssessmentAddress" class="form-control" type="text" title="address" value="<?php echo doNiceArrayElemAsString('address1'); ?>">
            </div>
        </div>
