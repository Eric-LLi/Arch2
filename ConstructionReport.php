...
<div class="container">
    ...
    <p>
        The Archicentre Australia Construction Quality Assurance Assessment Report is a visual assessment of the quality
        and workmanship of the property's consturction against acceptable industry standards
    </p>
</div>
<!-- Inspection Info -->
    ...
    <table>
        ...
        <tr>
            <th width="80%">
                ...
                <p style="font-weight: normal">After concrete footings are poured or after stumps, piers, columns or the concrete floor is
                    completed.</p>
            </th>
            <th>
        ...
        <div class="row form-group">
            <div class="col-sm-6">
                <input type="button" value="Upload Cover Image" class="uploadCoverImageButton"
                       onclick="ConstructionCover()">
                <input type="file" id="ConstructionUploadCoverImage" class="inputImage" accept="image/x-png,image/jpeg">
            </div>
            <div class="col-sm-6">
                <div class="col-sm">
                    <img id="ConstructionCoverImage" src="#" alt="Image1"
                         style="width:0;height:265px;display: none"/>
                </div>
                <div class="col-sm">
                    <input type="button" value="Remove" id="ConstructionCoverImageRemoveButton"
                           onclick="RemoveConstructionCoverImage()" style="display: none; margin-top: 5px;margin-bottom: 5px;width: 100%">
                    <br>
                </div>
            </div>
        </div>
...
<div class="container">
    ...
    <br>
    <table>
        <tr style="width:100%"><th class="sectionSubHeaderSmaller" colspan="6" style="color: red">External Elements</th></tr>
        <tr style="width:100%">
        ...
        <tr style="width:100%"><th class="sectionSubHeaderSmaller" colspan="6" style="color: black">Out Building & Attached Structures</th></tr>
        <tr>
            <td>
        ...
        <tr style="width:100%"><th class="sectionSubHeaderSmaller" colspan="6" style="color: black">External Building Elements</th></tr>
        <tr>
            <td>
        ...
        <tr style="width:100%"><th class="sectionSubHeaderSmaller" colspan="6" style="color: black">External Access Limitations</th></tr>
        <tr>
            <td>
    ...
    <br>
    <table>
        <tr style="width:100%"><th class="sectionSubHeaderSmaller" colspan="6" style="color: red">Internal Elements</th></tr>
        <tr style="width:100%">
        ...
        <tr style="width:100%"><th class="sectionSubHeaderSmaller" colspan="6" style="color: black">Internal Service (Wet) Areas</th></tr>
        <tr>
            <td>
        ...
        <tr style="width:100%"><th class="sectionSubHeaderSmaller" colspan="6" style="color: black">Services<sup>*</sup></th></tr>
        <tr>
            <td>
        ...
        <tr style="width:100%"><th class="sectionSubHeaderSmaller" colspan="6" style="color: black">Internal Access Limitations</th></tr>
        <tr>
            <td>
...
<div class="container">
    ...
    <div class="container">
        <input type="button" id="get_ConstructionImage" value="Upload Images (Max 30 images)" class="uploadImageButton"
               onclick="ConstructionUploadImages()" style="white-space: normal; width: 15%">
...
<div class="container">
    <hr>
    <p>
        The following selected attachments are an important part of this Report. These can be found in the Technical
        Information Booklet on the Archicentre Australia Supplementary Documents web page –
        <a href="http://www.archicentreaustralia.com.au/report_downloads/">http://www.archicentreaustralia.com.au/report_downloads/</a>
         - or by referring to the Report cover letter for downloading instructions.
        If you have difficulty downloading the Booklet, please contact Archicentre Australia on 1300 13 45 13 immediately.
